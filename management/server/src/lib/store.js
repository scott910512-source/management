...
const TABLES = {
  ...
  items: ['id', 'category', 'name', 'unit', 'safetyStock', 'warningPct', 'vendor', 'product', 'defaultQty', 'lotPattern', 'pkgType', 'pkgSize', 'pkgUnit', 'hazardous', 'hazardousMaxQty', 'hazardousWarnPct', 'note', 'createdBy', 'createdAt', 'updatedBy', 'updatedAt'],
