...
// 최소 ZIP(STORE, 비압축) 작성기 — 여러 CSV를 하나의 zip으로 묶어 내려주기 위한 용도.
// 외부 의존성 없이 표준 ZIP 포맷(로컬 헤더 + 중앙 디렉터리 + EOCD)을 직접 생성한다.
 ...
 * @returns {Buffer} zip 파일 바이너리(STORE=비압축)
 */
function buildZip(files, at = new Date()) {
